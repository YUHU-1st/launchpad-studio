...
- **Tools & Games** includes a scrolling digital clock, calendar, current weather, focus timer, Snake and Whack-a-Mole. Snake supports keyboard arrows, the first four top-row Launchpad buttons, or directional grid presses. Whack-a-Mole is played by pressing the lit physical pad.
